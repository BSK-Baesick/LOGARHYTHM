...
public class SpawnManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Cached all the references here
    ...
    public IEnumerator StartTheMusic()
    {
        ...
        while (gameManager.hasThePartyStarted == true);
    }
    ...
    private void SpawnBEATz(WaveConfiguration waveConfig, GameObject BEAT, GameObject newBEAT)
    {
